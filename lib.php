 ...
 * @return string
 */
function fuji_process_css($css, $theme) {
    ...
    $css = fuji_set_linkcolor($css, $linkcolor);
    ...
    $css = fuji_set_regionwidth($css, $regionwidth);
    ...
    $css = fuji_set_customcss($css, $customcss);
 ...
 * @return string
 */
function fuji_set_linkcolor($css, $linkcolor) {
...
function fuji_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function fuji_set_customcss($css, $customcss) {
